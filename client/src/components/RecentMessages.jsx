...
function RecentMessages() {
  ...
  async function fetchRecentMessages() {
    try {
      ...
      const { data } = await api.get(`/api/v1/user/recent-messages`, {
        headers: { Authorization: `Bearer ${token}` },
      });
      if (data.success) {
        // Group messages by sender and get the latest messafe for each sender
        ...
        // Convert object -> array, then sort by newest first.
